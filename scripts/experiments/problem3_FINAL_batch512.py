"""
Problem 3 - Custom Model (Optimized for RTX 4090)
Batch size 512 for faster training with your GPU
"""

# =============================================================================
# PROBLEM 3 - CUSTOM MODEL IMPLEMENTATION (GPU OPTIMIZED)
# =============================================================================

print("=" * 70)
print("PROBLEM 3 - CUSTOM MODEL (Bidirectional LSTM - GPU Optimized)")
print("=" * 70)
...
# =============================================================================
# TRAIN MODEL (GPU OPTIMIZED WITH BATCH SIZE 512)
# =============================================================================

print("\n" + "=" * 70)
print("TRAINING CUSTOM MODEL (Batch Size: 512)")
print("=" * 70)
print("GPU: RTX 4090 detected - utilizing CUDA acceleration")
...
custom_history = custom_model.fit(
    ...
    epochs=100,
    batch_size=512,  # GPU OPTIMIZED: Larger batch for faster training
...
samples_per_sec = (len(X_train) * len(custom_history.history['loss'])) / training_time
...
test_loss, test_acc = custom_model.evaluate(X_test, y_test_enc, batch_size=512, verbose=0)
print(f"\nTest Accuracy: {test_acc:.4f}")
print(f"Test Loss: {test_loss:.4f}")

# Generate predictions
y_pred_probs = custom_model.predict(X_test, batch_size=512, verbose=0)
